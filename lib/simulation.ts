...
const EVENT_TEMPLATES: Record<string, EventTemplate[]> = {
  ...
  bms: [
    ...
    { type: "champion_identified", agentName: "Research Agent", priority: "high", title: "Champion identified", explanation: "VP Dev Ops interested in Cursor for document workflows.", recommendedAction: "Win on architecture and time-to-value", operationalPhrase: "champion identified" },
