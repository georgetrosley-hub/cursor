...
export function ArchitectureSecurity({ account, competitors }: ArchitectureSecurityProps) {
  ...
  return (
    ...
    >
      ...
      {/* Cursor architecture recommendation */}
      <button
