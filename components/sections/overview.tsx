...
export function Overview({
  ...
  return (
    ...
    >
      {/* Cursor internal app feel */}
      <div className="flex flex-wrap items-center gap-2 rounded-xl border border-accent/15 bg-accent/[0.04] px-4 py-3">
        <CursorLogo size={16} className="text-accent" />
        <span className="text-[12px] font-medium text-text-primary">
          Enterprise GTM — track accounts, deal flow, and execution
        </span>
      ...
      <section className="space-y-4">
        ...
        <div className="max-w-4xl space-y-2">
          <h2 className="text-xl font-semibold tracking-tight text-text-primary sm:text-2xl">
            How we build pipeline and expansion for Cursor Enterprise at {account.name}
          </h2>
          <p className="max-w-3xl text-[14px] leading-relaxed text-text-muted">
            First wedge, champion path, pilot design, executive alignment, competitive displacement, and the expansion story — built for Cursor Enterprise AEs.
          </p>
        </div>
      </section>
