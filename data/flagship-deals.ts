...
const flagshipDeals: Record<string, FlagshipDealContext> = {
  jnj: {
    ...
    competitiveBattle: {
      ...
      displacementStrategy: "Position Cursor as the unified platform for trial analytics and RWE. Unity Catalog differentiates for regulated data. Land before Snowflake gains momentum.",
      keyRisk: "Snowflake Cortex and life sciences focus may win if we're slow. Need executive sponsor to prioritize Cursor pilot.",
      winCondition: "Clinical Data Sciences adopts Cursor for trial analytics. Quality comfortable with governance. Expands to RWE and R&D.",
    },
    milestones: [
  ...
  merck: {
    ...
    competitiveBattle: {
      ...
      winCondition: "R&D Data Platform adopts Cursor. Proves value. Expansion into clinical and manufacturing follows.",
    },
    milestones: [
  ...
  bms: {
    ...
    competitiveBattle: {
      ...
      winCondition: "Clinical Dev Ops adopts Cursor. Demonstrates value before Snowflake decision. Expands to RWE and regulatory.",
    },
    milestones: [
  ...
  sanofi: {
    ...
    competitiveBattle: {
      ...
      winCondition: "Vaccines Data adopts Cursor. EU compliance validated. Expands to other therapeutic areas.",
    },
    milestones: [
